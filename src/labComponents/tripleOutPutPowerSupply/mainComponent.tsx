...
const TripleOutput: React.FC<TripleOutputProps> = ({position, unique_id = "triple_output_supply", scale = [1, 1, 1]}) => {
  ...
  return (
    <group ref={groupRef} position={position} scale={scale}>
      {model && <primitive object={model} scale={[1.25, 1.25, 1.25]}/>} {/* Conditional rendering */}
    </group>
  );
};
